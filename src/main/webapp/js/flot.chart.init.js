...
$(function() {
    ...
    $(function() {
        $.ajax({
            ...
            type: 'POST',
            url: "adminater/driverDirs" ,
            dataType: "json",
            success :function(dataTemps){

               var data = [{
                    label: "在线",
                    data:  dataTemps.onLine
                }, {
                    label: "离线",
                    data:  dataTemps.offLine
                }, {
                    label: "忙碌",
                    data: dataTemps.busyLine
                }];
                var options = {
                    series: {
                        pie: {
        ...
        $.ajax({
            ...
            success :function(dataTemps){
                ...
                var options = {
                    ...
                    colors: ["#869cb3", "#6dc5a3", "#778a9f","#FF6C60","#B3EE3A"],
                    tooltip: true,
                    tooltipOpts: {
                        defaultTheme: false
                    }
